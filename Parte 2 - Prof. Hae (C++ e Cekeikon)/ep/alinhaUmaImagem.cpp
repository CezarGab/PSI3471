...
int main(){
    ...
    Mat_<GRY> a; le(a,"Jasmine (2).jpg"); // a sera' a versao binaria da imagem (para que certas funcoes funcionem)
    Mat_<COR> q; le(q,"Jasmine (2).jpg"); // q sera' a versao colorida da imagem
    ...
    imp(qRotETransl, "Jasmine (2)_alin.png");
}